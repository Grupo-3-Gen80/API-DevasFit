...
public class UsuarioController {
	...
	public ResponseEntity<Usuario> putUsuario(@Valid @RequestBody Usuario nomeUsuario) {
		
		return usuarioService.atualizarUsuario(nomeUsuario)
	...
	@GetMapping("/{id}/imc")
	public ResponseEntity<String> getIMC(@PathVariable Long id) {
